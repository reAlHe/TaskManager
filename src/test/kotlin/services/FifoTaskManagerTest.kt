...
internal class FifoTaskManagerTest {
    ...
    private lateinit var sut: FifoTaskManager
    ...
    fun setUp() {
        ...
        sut = FifoTaskManager(3, processList)
    }
    ...
    @Test
    fun `add process to task manager pops out the oldest process and adds the new one`() {
        ...
        assertThat(processList).containsExactly(process2, process3, process4)
